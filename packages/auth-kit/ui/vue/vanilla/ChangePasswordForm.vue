...
<template>
  <form novalidate class="auth-kit-form" @submit.prevent="handleSubmit">
    ...
    <p v-if="fieldErrors.currentPassword" class="auth-kit-error">
    ...
    <p v-if="fieldErrors.confirmPassword" class="auth-kit-error">
    ...
    <p v-if="authKit.state.value.changePassword.status === 'success'" class="auth-kit-success">

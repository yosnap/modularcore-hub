...
<template>
  <div class="flex flex-col gap-4">
    <div v-if="token" role="status" class="text-sm">
      <p v-if="authKit.state.value.verifyEmail.status === 'submitting'" class="text-zinc-700">
        Verificando tu email…
      </p>
      <p v-if="authKit.state.value.verifyEmail.status === 'success'" class="text-green-600">

  ...
  template: `
    <div class="flex flex-col gap-4">
      <div *ngIf="token" role="status" class="text-sm">
        <p *ngIf="authKit.state().verifyEmail.status === 'submitting'" class="text-muted-foreground">Verifying your email…</p>
      ...
      <form novalidate class="flex flex-col gap-4" (submit)="handleResendSubmit($event)">
        <div class="flex flex-col gap-1.5">
          <label class="text-sm font-medium leading-none" for="auth-kit-resend-email">Email</label>

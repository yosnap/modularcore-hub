...
<form onsubmit={handleSubmit} novalidate class="auth-kit-form">
  <div class="auth-kit-field">
    ...
    <div class="auth-kit-field__control">
      ...
      <button type="button" onclick={() => (showCurrent = !showCurrent)} aria-label={showCurrent ? 'Hide password' : 'Show password'} class="auth-kit-eye-button">
  ...
  <div class="auth-kit-field">
    ...
    <div class="auth-kit-field__control">
      ...
      <button type="button" onclick={() => (showNew = !showNew)} aria-label={showNew ? 'Hide password' : 'Show password'} class="auth-kit-eye-button">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  {#if flow.status === 'success'}<p class="auth-kit-success">Password updated.</p>{/if}
</form>

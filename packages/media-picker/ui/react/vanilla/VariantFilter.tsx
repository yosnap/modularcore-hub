...
/** Variante CSS plano: mismas props y comportamiento que el VariantFilter headless. Selección única: filtrar por dos tamaños a la vez no significa nada, porque cada objeto

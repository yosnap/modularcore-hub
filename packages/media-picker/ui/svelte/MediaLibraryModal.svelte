      ...
      {#if activeTab === 'library'}
        <div role="tabpanel">
          ...
          <div>
            ...
            <label>
              Orden
              <select value={sortValue ?? ''} onchange={(event) => handleSortChange(event.currentTarget.value)}>
            ...
            <label>
              Por página
              <select value={perPage} onchange={(event) => handlePerPageChange(Number(event.currentTarget.value))}>

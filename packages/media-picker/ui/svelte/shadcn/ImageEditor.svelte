    ...
    >
      ...
      <div class="grid flex-1 grid-cols-1 gap-4 overflow-y-auto p-4 md:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)]">
        <div class="flex flex-col gap-3">
          ...
          <div class="flex flex-wrap items-center gap-2">
            <button type="button" disabled={isBusy} onclick={() => picker.rotate('ccw')} class="rounded-md border border-input px-3 py-1.5 text-sm hover:bg-accent disabled:opacity-50">⟲ -90°</button>
            <button type="button" disabled={isBusy} onclick={() => picker.rotate('cw')} class="rounded-md border border-input px-3 py-1.5 text-sm hover:bg-accent disabled:opacity-50">⟳ +90°</button>
            <button type="button" disabled={isBusy} onclick={() => picker.flip('horizontal')} class="rounded-md border border-input px-3 py-1.5 text-sm hover:bg-accent disabled:opacity-50">⇋ Voltear H</button>
            <button type="button" disabled={isBusy} onclick={() => picker.flip('vertical')} class="rounded-md border border-input px-3 py-1.5 text-sm hover:bg-accent disabled:opacity-50">⇅ Voltear V</button>
          </div>

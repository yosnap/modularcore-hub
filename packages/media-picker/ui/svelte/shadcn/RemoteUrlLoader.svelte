...
<div class="flex flex-wrap items-end gap-2">
  <label class="flex flex-1 min-w-56 flex-col gap-1 text-sm text-foreground">
    URL de la imagen
    <span class="relative">
      <svg
        aria-hidden="true"
      ...
      <input
        ...
        class="w-full rounded-md border border-input bg-background py-1.5 pl-7 pr-2 text-sm focus:outline-none focus:ring-2 focus:ring-ring"
      />
    </span>
  </label>
  <button

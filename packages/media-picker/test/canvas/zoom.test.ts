...
// Mirrors test/ui/image-editor-zoom.test.ts's cases (React-only coverage) against the shared
// module every Svelte ImageEditor variant now imports instead of redefining locally.
describe('applyZoom (crop rect ↔ zoom slider mapping) — shared core/canvas/zoom module', () => {

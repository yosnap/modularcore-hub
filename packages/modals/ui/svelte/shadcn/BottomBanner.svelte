...
<div
  role="region"
  aria-live="polite"
  class="modals-bottom-banner{noMotionClass} fixed bottom-0 left-0 right-0 z-50 border-t border-border bg-card text-card-foreground shadow-sm{transitionClass}"
>

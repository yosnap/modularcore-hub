...
ModularCore Hub se distribuye a través de tres canales de primer nivel: **Web, CLI y MCP**. No son tres productos distintos, sino tres clientes delgados del mismo [registry HTTP](/1-0-0/conceptos/arquitectura/) — cada uno pensado para un contexto de uso diferente.

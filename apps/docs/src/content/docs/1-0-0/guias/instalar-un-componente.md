...
Si algo no encaja, la instalación se detiene con un error de compatibilidad antes de tocar el disco. Ver [Solución de problemas · CLI](/1-0-0/solucion-de-problemas/cli/) para el detalle de estos mensajes.
...
- [Actualizar componentes](/1-0-0/guias/actualizar-componentes/) para volver a sincronizar un componente ya instalado con el registry.
- [Solución de problemas · CLI](/1-0-0/solucion-de-problemas/cli/) para el detalle de los errores que puede mostrar `add`.

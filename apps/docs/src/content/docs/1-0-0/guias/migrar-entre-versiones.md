...
La documentación de ModularCore Hub conserva versiones archivadas cuando el mantenedor decide congelar un punto concreto (ver [Versionado](/1-0-0/conceptos/versionado/)). Esta guía describe cómo moverte entre esas versiones como lector.
...
Para trabajar con la versión vigente del componente que sea, actualiza tu instalación con [`modularcore update`](/1-0-0/guias/actualizar-componentes/) y consulta la documentación vigente (sin seleccionar ninguna versión archivada).

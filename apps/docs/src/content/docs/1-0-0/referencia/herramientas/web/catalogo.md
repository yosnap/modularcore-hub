...
- [Endpoints del registry](/1-0-0/referencia/herramientas/web/endpoints-registry/) — los mismos ficheros JSON que alimentan el catálogo, servidos por HTTP.
- [get_component](/1-0-0/referencia/herramientas/mcp/get-component/) — el equivalente vía servidor MCP para obtener el descriptor de un componente.

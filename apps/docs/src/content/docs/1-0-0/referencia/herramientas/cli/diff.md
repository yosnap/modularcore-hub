...
- [`update`](/1-0-0/referencia/herramientas/cli/update/) — aplica los cambios que `diff` muestra, con confirmación por archivo
- [`add`](/1-0-0/referencia/herramientas/cli/add/) — instalación inicial de un componente

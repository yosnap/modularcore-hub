...
- [`search`](/1-0-0/referencia/herramientas/cli/search/) — filtra el mismo índice por texto
- [`add`](/1-0-0/referencia/herramientas/cli/add/) — instala un componente listado aquí

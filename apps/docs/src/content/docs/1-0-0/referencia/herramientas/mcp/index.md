...
|---|---|---|
| [`search_components`](/1-0-0/referencia/herramientas/mcp/search-components/) | Registry HTTP (solo lectura) | no |
| [`get_component`](/1-0-0/referencia/herramientas/mcp/get-component/) | Registry HTTP (solo lectura) | no |
| [`install_component`](/1-0-0/referencia/herramientas/mcp/install-component/) | Registry HTTP + escritura en disco local | **sí** |
| [`check_updates`](/1-0-0/referencia/herramientas/mcp/check-updates/) | Registry HTTP (solo lectura) | no |
...
- [CLI de ModularCore](/1-0-0/referencia/herramientas/cli/) — el cliente de línea de comandos equivalente, mismo registry.
- [Visión general del catálogo web](/1-0-0/referencia/herramientas/web/) — la otra forma de consumir el mismo registry.

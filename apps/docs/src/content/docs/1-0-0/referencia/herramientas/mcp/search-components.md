...
- [get_component](/1-0-0/referencia/herramientas/mcp/get-component/) — obtener el descriptor completo de un componente concreto encontrado con esta tool.
- [check_updates](/1-0-0/referencia/herramientas/mcp/check-updates/) — comparar versiones instaladas contra el índice del registry.
- [Endpoints del registry](/1-0-0/referencia/herramientas/web/endpoints-registry/) — el `index.json` HTTP subyacente que esta tool consulta.

...
- [search_components](/1-0-0/referencia/herramientas/mcp/search-components/) — encontrar el nombre exacto de un componente antes de pedir su descriptor.
- [install_component](/1-0-0/referencia/herramientas/mcp/install-component/) — instalar el componente cuyo descriptor acabas de inspeccionar.
- [Endpoints del registry](/1-0-0/referencia/herramientas/web/endpoints-registry/) — el `{name}.json` HTTP subyacente que esta tool consulta.

...
`apps/web` es la aplicación SvelteKit que sirve **modularcorehub.com**: el catálogo visual de componentes y, a la vez, el servidor HTTP del registry que consumen tanto el [CLI](/1-0-0/referencia/herramientas/cli/) como el [servidor MCP](/1-0-0/referencia/herramientas/mcp/).
...
- [Cómo navegar el catálogo](/1-0-0/referencia/herramientas/web/catalogo/)
- [Endpoints del registry](/1-0-0/referencia/herramientas/web/endpoints-registry/)
- [CLI de ModularCore](/1-0-0/referencia/herramientas/cli/)
- [Servidor MCP](/1-0-0/referencia/herramientas/mcp/)

...
- [`list`](/1-0-0/referencia/herramientas/cli/list/) — lista el índice completo sin filtrar
- [`add`](/1-0-0/referencia/herramientas/cli/add/) — instala un componente encontrado con `search`

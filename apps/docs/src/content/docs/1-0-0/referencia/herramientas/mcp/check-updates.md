...
- [search_components](/1-0-0/referencia/herramientas/mcp/search-components/) — consultar el índice completo del registry.
- [install_component](/1-0-0/referencia/herramientas/mcp/install-component/) — reinstalar/actualizar un componente marcado como `outdated`.

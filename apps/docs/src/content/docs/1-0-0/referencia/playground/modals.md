...
Prueba el componente [Modals](/1-0-0/referencia/componentes/modals/) en vivo, directamente en tu
navegador, en:
...
(CMS, base de datos) — consulta [la documentación del componente Modals](/1-0-0/referencia/componentes/modals/)

...
Prueba el componente [Media Picker](/1-0-0/referencia/componentes/media-picker/) en vivo, directamente
en tu navegador, en:
...
Picker](/1-0-0/referencia/componentes/media-picker/) para el patrón de credenciales de corta duración.

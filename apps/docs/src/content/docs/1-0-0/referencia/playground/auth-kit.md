...
Prueba el componente [Auth Kit](/1-0-0/referencia/componentes/auth-kit/) en vivo, directamente en tu
navegador, en:
...
Kit](/1-0-0/referencia/componentes/auth-kit/) para los ejemplos con Better Auth y con una API propia.

...
Prueba el componente [AI Chat](/1-0-0/referencia/componentes/ai-chat/) en vivo, directamente en tu
navegador, en:
...
Chat](/1-0-0/referencia/componentes/ai-chat/) para el patrón BYOK (Bring Your Own Key).

...
- [AI Chat](/1-0-0/referencia/componentes/ai-chat/) — chat con streaming, function calling y fallback de
  modelos, compatible con cualquier endpoint OpenAI-compatible.
- [Auto SEO](/1-0-0/referencia/componentes/auto-seo/) — generación de datos estructurados JSON-LD para
  Schema.org.
- [Media Picker](/1-0-0/referencia/componentes/media-picker/) — selector de medios con recorte,
  compresión y subida a distintos proveedores de almacenamiento.
- [Auth Kit](/1-0-0/referencia/componentes/auth-kit/) — login, registro, cambio de contraseña,
  recuperación y verificación de email, contra el backend o librería de autenticación que ya usas.
- [Modals](/1-0-0/referencia/componentes/modals/) — sistema unificado de overlays (modal, fullscreen,
  banners, slide-in, toast) con elegibilidad y frecuencia de aparición.
- [Hello Core](/1-0-0/referencia/componentes/hello-core/) — componente mínimo de ejemplo usado como
  plantilla interna para el pipeline de copiado de la CLI.

Cada componente tiene además una demo interactiva en el [Playground](/1-0-0/referencia/playground/),

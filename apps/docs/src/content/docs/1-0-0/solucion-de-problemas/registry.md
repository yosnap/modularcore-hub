...
- [Solución de problemas · CLI](/1-0-0/solucion-de-problemas/cli/) para cómo se propagan estos errores a través de los comandos del CLI.
- [Solución de problemas · MCP](/1-0-0/solucion-de-problemas/mcp/) para la configuración de la URL del registry en el servidor MCP.

...
El CLI también reenvía, con el mismo formato limpio, los errores que produce la conexión al registry (fallo de red, 404, JSON inválido, descriptor con formato incorrecto). Consulta el detalle en [Solución de problemas · Registry](/1-0-0/solucion-de-problemas/registry/).

## Ver también

- [Instalar un componente](/1-0-0/guias/instalar-un-componente/) para el flujo completo de `add` y en qué punto aparece cada uno de estos errores.

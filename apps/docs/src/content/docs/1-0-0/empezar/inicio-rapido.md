...
Este es el flujo mínimo para pasar de un proyecto vacío a tener un componente de ModularCore Hub funcionando en tu código. Da por hecho que ya tienes el [CLI instalado](/1-0-0/empezar/instalacion/).
...
Para entender por qué el CLI funciona así, revisa [Arquitectura](/1-0-0/conceptos/arquitectura/) y [Los tres pilares](/1-0-0/conceptos/los-tres-pilares/). Para profundizar en `add`, `update` y `diff`, ve a la sección [Guías](/1-0-0/guias/instalar-un-componente/).
